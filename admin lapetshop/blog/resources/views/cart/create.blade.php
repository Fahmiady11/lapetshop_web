    ...
    <div class="animated fadeIn">
        ...
        <div class="card">
            <div class="card-header">
                <div class="pull-left">
                    <strong>Tambah Keranjang</strong>
                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select type="text" name="nama" class="form-control " >
                                    ...
                                    @foreach ($buyer as $item)                                    
                                        <option value="{{$item -> IdUser}}" {{ old('nama') == $item-> IdUser ? 'selected' : null}} > {{$item -> UserName}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select type="text" name="admin" class="form-control @error('admin') is-invalid @enderror" >
                                    ...
                                    @foreach ($admin as $item)                                    
                                        <option value="{{$item -> IdAdmin}}" {{ old('admin') == $item-> IdAdmin ? 'selected' : null}} > {{$item -> AdminName}}</option>
                                    @endforeach
                                </select>
                                @error('admin')                                    
                                    <div class="invalid-feedback">{{ $message }}</div>
