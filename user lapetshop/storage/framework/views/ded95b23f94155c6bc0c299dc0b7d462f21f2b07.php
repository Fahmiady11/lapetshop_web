...
<?php $component = $__env->getContainer()->make(App\View\Components\Layout::class, ['title' => 'login','layout' => 'login']); ?>
                    ...
                    <div class="col-lg-8 pl-lg-0">
                        <div class="card card-details mt-4 border-0">
                            ...
                            <div class="row">
                                <div class="container ">
                                    <div class="center">
                                        <img class="drop-shadow" src="<?php echo e(asset('img/Shopping.png')); ?>" style="max-width: 700px;" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php endif; ?><?php /**PATH D:\KULIAH\TUGAS\paw\lapetshop\resources\views/TugasPaw/login.blade.php ENDPATH**/ ?>